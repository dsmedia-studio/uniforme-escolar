(function () {
  ...
  var FONT_CONFIG = {
    headline: { min: 12, max: 18, shortThreshold: 30, longThreshold: 70 },
    subtext: { min: 10, max: 15, shortThreshold: 40, longThreshold: 90 }
  };
  ...
  devDynamicContent[PROFILE_NAME] = [
    {
      ...
      Personagem_Asset: { Type: "file", Url: "../assets/images/personagens/728x90/menina01_728x90.png" },
