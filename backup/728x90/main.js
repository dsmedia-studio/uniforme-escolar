(function () {
  ...
  var PROFILE_ID = 0;
  var CREATIVE_SIZE = { width: 728, height: 90 };
  ...
  devDynamicContent[PROFILE_NAME] = [
    {
      ...
      Personagem_Asset: { Type: "file", Url: "menina01_728x90.png" },
      ...
      ExitURL: {
        Url: "https://agenciabrasilia.df.gov.br/w/cartao-uniforme-escolar-permite-a-aquisicao-de-itens-para-estudantes-da-rede-publica-em-malharias-credenciadas?redirect=%2Fnoticias&utm_source=dv360&utm_medium=display&utm_campaign=uniforme_escolar&utm_content=default_728x90"
      }
    }
  ];

  var FONT_CONFIG = {
    headline: { min: 14, max: 18 },
    subtext: { min: 16, max: 16 }
  };
  ...
  function init() {
    ...
    // Fallback: sempre inicia após breve delay, com ou sem Enabler
    setTimeout(function() {
      if (!animationStarted) {
        runAd();
      }
    ...
    // Também tenta via Enabler se disponível
    if (typeof Enabler === "object" && typeof Enabler.isInitialized === "function") {
