(function () {
  ...
  var FONT_CONFIG = {
    headline: { min: 22, max: 34, shortThreshold: 25, longThreshold: 60 },
    subtext: { min: 16, max: 26, shortThreshold: 35, longThreshold: 70 }
  };
  ...
  devDynamicContent[PROFILE_NAME] = [
    {
      ...
      Personagem_Asset: { Type: "file", Url: "../../970x250/menina01_970x250.png" },
