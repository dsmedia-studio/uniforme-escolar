(function () {
  ...
  // Configuracao de fonte dinamica - 300x250 (medium rectangle)
  var FONT_CONFIG = {
    headline: { min: 14, max: 22, shortThreshold: 25, longThreshold: 60 },
    subtext: { min: 12, max: 17, shortThreshold: 35, longThreshold: 70 }
  };
  ...
  devDynamicContent[PROFILE_NAME] = [
    {
      ...
      Personagem_Asset: { Type: "file", Url: "../../300x250/menina01_300x250.png" },
