(function () {
  ...
  var PROFILE_ID = 0;
  var CREATIVE_SIZE = { width: 970, height: 250 };
  ...
  devDynamicContent[PROFILE_NAME] = [
    {
      ...
      Personagem_Asset: { Type: "file", Url: "menina01_970x250.png" },
      ...
      ExitURL: {
        Url: "https://agenciabrasilia.df.gov.br/w/cartao-uniforme-escolar-permite-a-aquisicao-de-itens-para-estudantes-da-rede-publica-em-malharias-credenciadas?redirect=%2Fnoticias&utm_source=dv360&utm_medium=display&utm_campaign=uniforme_escolar&utm_content=default_970x250"
      }
    }
  ];
